...
ShadowRenderpass::ShadowRenderpass(const VkCtx& ctx) : _ctx(ctx)
{
	createRenderPass();
}

VkRenderPass ShadowRenderpass::renderPass()
{
	return _renderPass;
}
...
{
	vkDestroyRenderPass(_ctx.device(), _renderPass, allocCallback);
}
